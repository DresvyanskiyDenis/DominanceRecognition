...
def extract_features(path_to_dataset:str, extractor_type:str, chunk_size:float, output_path:str)->None:
    """ Extracts features from the DOME dataset using the provided extractor type and chunk size. The features
    ...
    :param path_to_dataset: str
        The path to the dataset. It should contain session_name/audio/*Headset*.wav files
    ...
    # get all filenames
    audio_filenames = glob.glob(path_to_dataset + '/*/audio/*Headset*.wav')
    # extract features
